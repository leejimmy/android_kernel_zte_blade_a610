...
#endif
/* modify@zte.com.cn 201500906 s-- */
#ifdef CONFIG_WIND_DISABLE_HOMEKEYEINT	
	pmic_enable_interrupt(1,0,"PMIC");
	pmic_enable_interrupt(3,0,"PMIC");
#endif
/* modify@zte.com.cn 201500906 e-- */
	return 0;
}
